                ...
                return (
                  <TableRow key={cartItem.id}>
                    ...
                    <TableCell>
                      ...
                      >
                        <Button variant="outlined" size="small" color="error" onClick={() => updateQuantity(cartItem, false)}>
                          -
                        </Button>
                        <Typography>{cartItem.quantity}</Typography>
                        <Button variant="outlined" size="small" color="error" onClick={() => updateQuantity(cartItem, true)}>
                          +
                        </Button>
                      </Box>
                    </TableCell>
